...
while True:
	...
	f.close()
	os.system("/home/amisanghavi/mininet/server1/hello.py"+" "+filename)
	

    if option=="3":
	print "Inside listf"
	myList=os.listdir("/home/amisanghavi/mininet/server1")
	...
	os.system("/home/amisanghavi/mininet/server1/hello.py"+" "+original_filename+" "+new_filename)
	conn.close()
